...
def generate_with_deepseek_api(prompt, api_key):
    ...
    try:
        response = client.chat.completions.create(
            ...
            max_tokens=5000,  # Increased max_tokens to ensure complete response
            temperature=0.7,
            stream=False
        )
...
def main():
    ...
    # Create a set to track unique tattoo descriptions
    unique_tattoos = set()
    ...
    for _, row in df.iterrows():
        ...
        # Skip if this tattoo description has already been processed
    ...
    {{
        ...
        if response:
            ...
            try:
                ...
                output_path = os.path.join(output_dir, 'llm_tatuajes_procesados.csv')
